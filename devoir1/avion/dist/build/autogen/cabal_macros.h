...
/* package avion-0.1.0.0 */
#define VERSION_avion "0.1.0.0"
#define MIN_VERSION_avion(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "avion-0.1.0.0"

#define CURRENT_PACKAGE_KEY "avion-0.1.0.0"
