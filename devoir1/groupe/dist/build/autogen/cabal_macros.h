...
/* package groupe-0.1.0.0 */
#define VERSION_groupe "0.1.0.0"
#define MIN_VERSION_groupe(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "groupe-0.1.0.0"

#define CURRENT_PACKAGE_KEY "groupe-0.1.0.0"
